    ...
    var D = {
        ...
        $ = {
            ...
            addPreValue: function (s, o) {
                ...
                for (var i = 0; i < s.currentValue.length; i++) {
                    if (s.currentValue[i]) {
                        newArray.push(s.currentValue[i]);
                    }
                }
                s.currentValue = newArray;
            ...
            adjustScroll: function (e) {
                ...
                o && o.length && (t = o.position().top, t < 0 ? s.$container.scrollTop(a + t) : (n = t + o.outerHeight(), i = s.$container.innerHeight(), n > i && s.$container.scrollTop(a - i + n)),
                    s.currentValue = s.addPrevValue(s),
                    s.el.val(s.currentValue + s.suggestions[e].value + ","))
            }
        };
